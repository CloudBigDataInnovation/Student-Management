...
def empMenu():
    ...
    headingFrame2.place(relx=0.01,rely=0.05,relwidth=0.98,relheight=0.5)
        
    headingLabel = Label(headingFrame2, text="Admin MENU", fg='black')
    headingLabel.place(relx=0.25,rely=0.05, relwidth=0.5, relheight=0.4)
    
    btn1 = Button(root,text="View Course",bg='black', fg='white', command=ViewCourse)
    btn1.place(relx=0.28,rely=0.2, relwidth=0.45,relheight=0.1)
    
    btn2 = Button(root,text="Add Course",bg='black', fg='white', command=addCourses)
    btn2.place(relx=0.28,rely=0.3, relwidth=0.45,relheight=0.1)
    
    btn3 = Button(root,text="Delete Course",bg='black', fg='white', command=courseDelete)
    btn3.place(relx=0.28,rely=0.4, relwidth=0.45,relheight=0.1)
    
    btn4 = Button(root,text="View Users",bg='black', fg='white', command=viewUser)
    btn4.place(relx=0.28,rely=0.5, relwidth=0.45,relheight=0.1)
    
    btn5 = Button(root,text="Add User",bg='black', fg='white', command=addUsers)
    btn5.place(relx=0.28,rely=0.6, relwidth=0.45,relheight=0.1)
    
    btn6 = Button(root,text="Delete User",bg='black', fg='white', command=userDelete)
    btn6.place(relx=0.28,rely=0.7, relwidth=0.45,relheight=0.1)
    
    btn7 = Button(root,text="View Grade",bg='black', fg='white', command=viewGrade)
    btn7.place(relx=0.28,rely=0.8, relwidth=0.45,relheight=0.1)
    
    btn8 = Button(root,text="Grade for Student Course",bg='black', fg='white', command = gradeStudent)
...
def gettingLoginDetails():
    ...
    if (role == 'emp'):
        sqlLoginID = "select user_number from "+empTable+" where password = '"+password+"'"
...
def EmpRegister():
    ...
    # Employee ID
    lb1 = Label(labelFrame,text="Student Number : ", bg='#044F67', fg='white')
    ...
    #Employee Name
    lb2 = Label(labelFrame,text="Student Name : ", bg='#044F67', fg='white')
    ...
    #Employee Department
    lb4 = Label(labelFrame,text="Course Number : ", bg='#044F67', fg='white')
    ...
    lb5 = Label(labelFrame,text="Course Name : ", bg='#044F67', fg='white')
    ...
    # Employee Salary
    lb5 = Label(labelFrame,text="Professor Name : ", bg='#044F67', fg='white')
...
def Admin():
    ...
    headingLabel = Label(headingFrame2, text="Welcome Admin", fg='black')
...
headingLabel = Label(headingFrame2, text="Welcome to Lambton College", fg='black')
headingLabel.place(relx=0.25,rely=0.1, relwidth=0.5, relheight=0.5)

btn1 = Button(root,text="Admin",bg='black', fg='white', command=empMenu)
btn1.place(relx=0.25,rely=0.3, relwidth=0.2,relheight=0.1)

btn2 = Button(root,text="Student",bg='black', fg='white', command=viewGrade) #stuMenu Student
btn2.place(relx=0.55,rely=0.3, relwidth=0.2,relheight=0.1)

btn3 = Button(root,text="Login",bg='black', fg='white', command=Login) #stuMenu Student
btn3.place(relx=0.65,rely=0.4, relwidth=0.2,relheight=0.1)
